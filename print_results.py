...
def print_results(results_dic, results_stats_dic, model, 
    ...
    if (print_incorrect_dogs and ((results_stats_dic['n_correct_dogs'] + 
        ...
        for key in results_dic:
            if ((results_dic[key][3] == 1 and results_dic[key][4] == 0) or
                ...
                print('{:20}: {:20}'.format('Classifier label', results_dic[key][4]))
    ...
    if (print_incorrect_breed and (results_stats_dic['n_correct_dogs'] != results_stats_dic['n_correct_breed'])):
        ...
        for key in results_dic:
            if (results_dic[key][2] == 0 and results_dic[key][3] == 1 and results_dic[key][4] == 1):
